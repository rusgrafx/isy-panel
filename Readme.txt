*** ISY Panel - location-driven GUI system for ISY-99i home automation controller ***

Note: Please enable "Word wrap" in your text editor to see this document in its entirety.
...
* Networking module for ISY-99i (since the entire project is hosted inside ISY-99i)
* Chrome browser support on touch panels. ISY Panel may work just fine on other browsers as well, but Chrome provides ability to save web page as an Application (see menu Tools/Create application shortcuts), which comes in handy.
...
If you have answerred "No" to the above questions then ISY Panel might be right for you.
